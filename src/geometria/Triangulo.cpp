...
Triangulo::Triangulo() {
    ...
    this->set_vertice3(Ponto3(0.0, 0.0, 1.0));

    this->normal = (this->get_vertice2() - this->get_vertice1()).vetorial(this->get_vertice3() - this->get_vertice1()).unitario();
...
double Triangulo::escalar_interseccao(Raio& raio) const {
    ...
    // Plano do triângulo.
    Plano plano(this->get_vertice1(), this->normal, this->get_material());
